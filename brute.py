...
def banner():
    ...
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   NEW TOOLS HACK FACEBOOK BRUTEFORCE.   ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: tamamul.inc             |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |            FACEBOOK: tamamul            |"
    print Y+"  |             MAIL: tamamjgs@gmail.com              |"
    print GL+"  |---------------------------------------------|"
...
print wd+"         https://www.github.com/tamamul "
...
def pil():
                ...
                if g == 'y' or g == 'Y':
                    ...
                    print RR+"Pilih yang bener paman..."
                    pil()

def edit_wordlist():

        print GG+" "
        ed = str(raw_input("[?] Edit wordlist paman.? \033[96;1m[y/n]: "))
        if ed == 'y' or ed == 'Y':
        ...
        -o:  -.......        ..       `:o-
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              ...
              Powered by:\033[97m tamamul Hack
      """
